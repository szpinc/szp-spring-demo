...
import me.szp.framework.spring.beans.GenericBeanDefinition;
import me.szp.framework.spring.context.config.annotation.Autowired;
import me.szp.framework.spring.context.config.annotation.Component;
...
/**
 * @author leeSmall
 * @Description: 注解bean定义读取器, 从Resource里面加载bean定义、创建bean定义、注册bean定义到bean工厂
 * @date 2018年12月7日
 */
